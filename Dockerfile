...
#
# Generated on 2022-10-31T17:33:30Z by kres 03328da.
...
RUN FILES="$(goimports -l -local github.com/siderolabs/go-cmd .)" && test -z "${FILES}" || (echo -e "Source code is not formatted with 'goimports -w -local github.com/siderolabs/go-cmd .':\n${FILES}"; exit 1)
