...
#
# Generated on 2021-02-16T13:15:08Z by kres latest.
...
RUN FILES="$(gofumports -l -local github.com/talos-systems/go-cmd .)" && test -z "${FILES}" || (echo -e "Source code is not formatted with 'gofumports -w -local github.com/talos-systems/go-cmd .':\n${FILES}"; exit 1)
